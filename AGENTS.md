...
- **Shebang**: start every `.ts` or `.mts` file with `#!/usr/bin/env bun`
...
- **Shared code**: put reusable helpers and utilities in `scripts/lib/` — operational scripts import from there.
